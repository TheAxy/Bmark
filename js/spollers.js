...
Если нужно включать\выключать работу спойлеров на разных размерах экранов пишем:
    data-spollers='992,max' - работает на экранах меньше или равно 992px
    data-spollers='768,min' - работает на экранах больше или равно 768px
Если нужно чтобы в блоке открывался только 1 спойлер - data-one-spoller
*/
...
if (spollersArray.length > 0) {
    ...
    // Инциализация обычных спойлеров
    ...
    // Инциализация спойлеров с медиа запросами
